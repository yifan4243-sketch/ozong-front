...
export function MembershipReplica(){
 const [code,setCode]=useState("");const [days,setDays]=useState(330);const [toast,setToast]=useState("");const [redeeming,setRedeeming]=useState(false);const redeemRef=useRef<HTMLElement|null>(null);
 ...
 return <div className="membership-page-source"><DemoToast text={toast}/>
  <section className="current-membership-source tone-gold"><div><span>OZONG MEMBERSHIP</span><h1>年卡会员</h1><p>当前会员有效期至 2027-08-19</p></div><div className="member-stats-source"><span><b>2/5</b><small>登录设备</small></span><span><b>6/10</b><small>店铺数量</small></span><span><b>{days}天</b><small>剩余时间</small></span></div></section>
