...
export function MembershipReplica(){
 ...
 return <div className="membership-page-source"><DemoToast text={toast}/>
  <section className="current-membership-source tone-gold"><div><span>OZONG MEMBERSHIP</span><h1>年卡会员</h1><p>当前会员有效期至 2027-04-26</p></div><div className="member-stats-source"><span><b>2/5</b><small>登录设备</small></span><span><b>3/10</b><small>店铺数量</small></span><span><b>{days}天</b><small>剩余时间</small></span></div></section>
